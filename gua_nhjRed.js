...
let rebateCodes = 'SwMRK5G'
let rebatePin = 'jd_5cb0014e6c6c6,jd_QtHuFWIAjWHD,jd_771db194895a9,jd_4c892e16c8add,jd_52cee05f1492c'
...
function getUrl() {
  return new Promise(resolve => {
    if($.again == false) rebateCode = 'S'+'w'+'M'+'R'+'K'+'5'+'G'
    const options = {
