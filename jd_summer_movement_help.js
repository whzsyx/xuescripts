...
!(async () => {
  ...
  // 助力
  let res = [], res2 = [];
  $.innerShInviteList = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/summer_movement_one.json');
  res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/summer_movement.json');
  if(!$.innerShInviteList[0]){
    $.innerShInviteList = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/summer_movement.json');
  }
  if(!res2[0]){
    res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/summer_movement.json');
  }
