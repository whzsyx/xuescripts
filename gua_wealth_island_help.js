...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/wealth_island_code_one.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/whzsyx/updateTeam@main/shareCodes/wealth_island_code.json');
