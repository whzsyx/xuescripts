...
活动时间：2021-12-12日结束
活动入口：京东APP首页右边浮动飘窗
10 0,8 * * * jd_split.js, tag=年终奖, enabled=true
cron "10 0,8 * * *" script-path=jd_split.js,tag=年终奖
 */
const $ = new Env('金榜年终奖');
...
!(async () => {
  ...
  //https://raw.githubusercontent.com/whzsyx/updateTeam/main/shareCodes/split.json
